...
public class EncryUtil {
	...
	public static String handleRSA(TreeMap<String, Object> map,
		...
		String sign = "";
		if (StringUtils.isEmptyString(privateKey)) {
...
//
//		/** 3.取得data明文sign。 */
////		String sign = StringUtils.isEmptyString(map.get("sign"));
...
//			if(StringUtils.isEqualsString((String) entry.getKey(), "sign")) {
//				continue;
//			}
...
//	}
	...
	public static String handleHmac(TreeMap<String, String> map, String hmacKey) {
		...
		String hmac = "";
		if (!StringUtils.isEmptyString(hmacKey)) {
