package com.notificationguard.vmq;
...
import com.notificationguard.R;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (!VMQUtils.checkBatteryWhiteList(this)) {
    ...
    public void startQrCode(View v) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            // 申请权限
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.CAMERA}, com.notificationguard.vmq.util.Constant.REQ_PERM_CAMERA);
            return;
        }
        // 申请文件读写权限（部分朋友遇到相册选图需要读写权限的情况，这里一并写一下）
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            // 申请权限
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, com.notificationguard.vmq.util.Constant.REQ_PERM_EXTERNAL_STORAGE);
            return;
        }
        // 二维码扫码
        Intent intent = new Intent(MainActivity.this, CaptureActivity.class);
        startActivityForResult(intent, com.notificationguard.vmq.util.Constant.REQ_QR_CODE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //扫描结果回调
        if (requestCode == com.notificationguard.vmq.util.Constant.REQ_QR_CODE && resultCode == RESULT_OK) {
